...
According to these two plots the best attraction for couples to visit in Formentera is "Formentera Divers". It has the highest rating and the most ratings from couples of all other attractions. But to determine if it really is the best attraction for couples to visit in Formentera I also looked at the ratings of other types of travelling groups.
```{r incluse-image, echo=FALSE}
